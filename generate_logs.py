...
{ts(3)}  routeur   kernel: [FWD] 192.168.10.10 → 10.0.0.10 via 192.168.10.254 (fwd)
{ts(4)}  routeur   kernel: [FWD] 10.0.0.2540 → 192.168.10.10 via 10.0.0.254 (fwd)
{ts(5)}  routeur   kernel: [FWD] 192.168.10.10 → 10.0.0.10 via 192.168.10.254(fwd)
{ts(6)}  routeur   kernel: [FWD] 10.0.0.10 → 192.168.10.10 via 10.0.0.254 (fwd)
{ts(7)}  routeur   kernel: [FWD] 192.168.10.10 → 10.0.0.10 via 192.168.10.254(fwd)
...
# ════════════════════════════════════════════════════════════════════════════════
wrong_mask = f"""
{ts(0)}  pc_b      NetworkManager: interface eth0 configured: ip=192.168.10.11/16 gw=192.168.10.254
...
{ts(7)}  switch_lan kernel: [SEC] duplicate MAC detected on port 3 and port 7 for IP 192.168.10.254
